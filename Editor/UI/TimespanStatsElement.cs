...
namespace DevStatsSystem.UI
{
    ...
    internal partial class TimespanStatsElement : VisualElement
    {
        ...
        private const string TIMESPAN_GRAPH_ELEMENT_TAG = "timespan-graph-element";
        ...
        private TimespanGraphElement m_timespanGraphElement;
        ...
        private void CreateLayout()
        {
            ...
            m_timespanGraphElement = this.Q<TimespanGraphElement>(TIMESPAN_GRAPH_ELEMENT_TAG);
